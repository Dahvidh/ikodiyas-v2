...
const testimonials = [
  {
    quote:
      "LENSING completely transformed the way our brand presents itself. Every frame felt intentional and the final result exceeded our expectations.",
    name: "David N.",
    role: "Founder, Creative Brand",
  },
  {
    quote:
      "The editing captured exactly what we wanted to communicate. The pacing, transitions and overall storytelling were incredible.",
    name: "Michael A.",
    role: "Brand Director",
  },
  {
    quote:
      "Professional from the first conversation to the final delivery. The finished film looked far beyond what we imagined.",
    name: "Sarah O.",
...
export default function Testimonials() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#050505] px-6 py-32 text-white md:py-40">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative min-h-[420px] overflow-hidden border border-white/10 bg-white/[0.02]">
          <article
            className={`flex min-h-[420px] flex-col justify-between p-8 md:p-14 lg:p-20 transition-opacity duration-700 ease-in-out ${
