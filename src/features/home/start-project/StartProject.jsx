export default function StartProject() {
    return (<section id="contact" className="relative overflow-hidden bg-[#050505] px-6 py-32 text-white md:py-48">
      <div className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.02] px-6 py-20 sm:px-10 md:px-16 md:py-28">
          ...
          <div className="relative max-w-4xl">
            ...
            <a href="mailto:hello@lensing.com" className="group mt-10 inline-flex items-center gap-4 rounded-full bg-white px-7 py-4 text-sm font-medium text-black transition-all duration-300 hover:bg-amber-400">
