...
export default function Footer() {
    return (<footer className="border-t border-white/10 bg-[#050505] px-6 py-16 text-white md:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-14 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr]">
          ...
          <div>
            ...
            <a href="mailto:hello@lensing.com" className="mt-7 inline-block text-sm text-white/60 transition-colors duration-300 hover:text-amber-400">
              hello@lensing.com
            </a>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col items-start gap-4">
              <a href="#work" className="text-sm text-white/50 transition-colors hover:text-white">
                Work
              </a>
              ...
              <a href="#process" className="text-sm text-white/50 transition-colors hover:text-white">
                Process
              </a>
          ...
          <div>
            ...
            return (<a key={social.name} href={social.href} target="_blank" rel="noopener noreferrer" aria-label={`${social.name} - ${social.handle}`} className="group flex items-center justify-between border-b border-white/10 py-4 transition-colors duration-300 hover:border-amber-400/40">
