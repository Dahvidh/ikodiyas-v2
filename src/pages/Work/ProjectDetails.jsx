...
const projects = {
    "project-one": {
        ...
        description: "A cinematic visual project crafted around strong storytelling, intentional pacing, and a polished visual language.",
        heroVideo: "https://res.cloudinary.com/dgqcoefvx/video/upload/v1783816345/hero_g6qmqy.mp4",
        projectVideo: "https://res.cloudinary.com/dgqcoefvx/video/upload/v1783816345/hero_g6qmqy.mp4",
    },
    "project-two": {
        title: "Project Two",
        ...
        description: "An experimental visual piece exploring movement, atmosphere, rhythm, and cinematic storytelling.",
        heroVideo: "https://res.cloudinary.com/dgqcoefvx/video/upload/v1783816345/hero_g6qmqy.mp4",
        projectVideo: "https://res.cloudinary.com/dgqcoefvx/video/upload/v1783816345/hero_g6qmqy.mp4",
    },
};
export default function ProjectDetails() {
    ...
    if (!project) {
        return (<main className="min-h-screen bg-[#050505] px-6 py-32 text-white">
        <div className="mx-auto max-w-7xl">
          ...
          <Link to="/work" className="mt-8 inline-flex text-sm text-amber-400">
            ← Back to work
          </Link>
        </div>
      </main>);
    ...
    return (<main className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="px-6 pb-20 pt-32 md:pb-28 md:pt-40">
        <div className="mx-auto max-w-7xl">
          ...
          <Link to="/work" className="text-xs uppercase tracking-[0.25em] text-white/40 transition-colors hover:text-amber-400">
            ← Back to work
          </Link>
          ...
          <div className="mt-16 overflow-hidden border border-white/10 bg-black">
            <video src={project.heroVideo} autoPlay muted loop playsInline controls className="aspect-video w-full object-cover"/>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 pb-24 md:pb-32">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="overflow-hidden border border-white/10">
            <video src={project.projectVideo} controls playsInline className="aspect-video w-full object-cover"/>
          </div>
      ...
      <section className="border-y border-white/10 px-6 py-24 md:py-32">
        ...
        ].map(([number, title, text]) => (<div key={number} className="bg-[#050505] p-8 md:p-10">
      ...
      <section className="px-6 py-24 md:py-32">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 md:flex-row md:items-end">
          ...
          <Link to="/work" className="group inline-flex items-center gap-3 border border-white/10 px-6 py-4 text-sm uppercase tracking-[0.2em] transition-all hover:border-amber-400/50 hover:text-amber-400">
            View all work
